var projects = [
	...
	{	
		...
		coverImage: {
			...
			small: '/src/img/projects/china/cover_sm.jpg',
			xs: '/src/img/projects/china/cover_xs.jpg'
		},
		projectImages: [
			{
			...
			},
			{
				...
				alt: 'Door at the Forbidden City – Beijing'
			},
			{
				...
				alt: 'Sunset at the Temple of Heaven – Beijing'
			},
			{
			...
			},
			{
				...
				alt: 'Forbidden City Statue – Beijing'
			},
			{
			...
			},
			{
				...
				alt: 'Incense Burning in Temple – Chengdu'
			},
			{
				...
				alt: 'Burning Incense – Chengdu Temple'
			},
			{
				...
				alt: 'Lantern Hanging in Temple – Chengdu'
			},
			{
			...
			},
			{
				...
				alt: 'Bridge in Panda Sanctuary – Chengdu'
			},
			{
				...
				alt: 'Panda Eating Bamboo– Chengdu'
			},
			{
				...
				alt: 'Etching in Bamboo – Chengdu Panda Sanctuary'
			},
			{
			...
			},
			{
				...
				alt: 'Archway to Game Spot in the Summer Palace - Beijing'
			},
			{
				...
				alt: 'Water Reed Plants in the Summer Palace – Beijing'
			},
			{
				...
				alt: 'Doorway – Summer Palace - Beijing'
			},
			{
				...
				alt: 'Detail – Summer Palace – Beijing'
			},
			{
				...
				alt: 'The Marble Boat – Summer Palace – Beijing'
			},
			{
				...
				alt: 'Pagoda in the distance – Summer Palace – Beijing'
			},
			{
				...
				alt: 'Stairway to Temple – The Summer Palace – Beijing'
			},
			{
				...
				alt: 'Man Watches Sunset – Summer Palace – Beijing'
			},
			{
				...
				alt: 'Boat on the Lake at The Summer Palace – Beijing'
			},
			{
				...
				alt: 'Doorway to Courtyard – The Summer Palace – Beijing'
			},
			{
				...
				alt: 'Sunset over the Lake at The Summer Palace – Beijing'
			},
			{
				...
				alt: 'The 17 Arch Bridge – Summer Palace – Beijing'
			},
			{
				...
				alt: 'The Great Wall of China – Detail – Beijing'
			},
			{
				...
				alt: 'The Great Wall of China – Steps – Beijing'
			},
			{
				...
				alt: 'The Great Wall of China – Step Detail – Beijing'
			},
		],
		...
		projectImages: [
			{
				...
				alt: 'Dry Plant Women\'s Snowboard'
			},
			{
...

	{
		...
		title: 'Bump & Grind',
		description: [
			'Bump & Grind is a boutique, self-established coffee business in Clapham. The project consisted of website design, brochure design, and packaging for a coffee martini.',
			'Working closely with the brand, I managed to capture the urban culture the business was trying to push, and continue to work with them on an ongoing basis.'
		],
		coverImage: {
		...
		projectImages: [
			...
			},
			{
				...
				alt: 'Photography and Instagram Photos'
			},
			{
			...
			},
			{
				...
				alt: 'Website Design and Mobile Mockup'
			},
			{
			...
			},
			{
				...
				alt: 'Coffee Martini Bottle Branding'
			},
			{
...

	{
		...
		description: [
			'Redesigning my personal portfolio website after a year and a half of having my first website live. My first website was also my first web design project so felt dated, and slow. There were many improvements that could have been made, and so I decided to update the website, not just the code, but to give it a more professional look too.',
			'My new website focuses on the work, and gives precedence to fewer, more major projects. I used angularJS to build the main website, and Wordpress for the blog. The result is a much cleaner, faster, and more intuitive professional website.'
		],
		coverImage: {
		...
		projectImages: [
			...
			},
			{
				...
				alt: 'Sketch Development'
			},
			{
				large: '/src/img/projects/website2016/W-05_lg.jpg',
				medium: '/src/img/projects/website2016/W-05_md.jpg',
				small: '/src/img/projects/website2016/W-05_sm.jpg',
			...
			},
			{
				...
				alt: 'Design of Blog and Projects'
			},
			{
...

	{
		...
		projectImages: [
			...
			},
			{
				...
				alt: 'Menu Design and Skier Photo'
			},
			{
				...
				alt: 'Detailed Design of Athlete, Artist and Events Screens'
			},
			{
			...
			},
			{
				...
				alt: 'Results, Map and Social Mockups'
			},
			{
			...
			},
			{
				...
				alt: 'Winter and Summer Logo Variants'
			},
			{
...

	{
		...
		description: [
			'Designing the web-client for the Palringo social gaming app. As part of the creative team, myself and one other designer helped shape the overall look and feel, and User Experience of the <a href="http://chat.palringo.com" title="Palringo WebUI Client" target="_blank">new web-client for the app.</a>',
